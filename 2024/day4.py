    ...
    for row in range(1, len(grid) - 1):
        for col in range (1, len(grid[row]) - 1):
            if grid[row][col] == 'A':
                ...
                if (grid[row + axes[0][0][0]][col + axes[0][0][1]] == 'M' and grid[row + axes[0][1][0]][col + axes[0][1][1]] == 'S') or \
                    (grid[row + axes[0][0][0]][col + axes[0][0][1]] == 'S' and grid[row + axes[0][1][0]][col + axes[0][1][1]] == 'M'):
                    if (grid[row + axes[1][0][0]][col + axes[1][0][1]] == 'M' and grid[row + axes[1][1][0]][col + axes[1][1][1]] == 'S') or \
                    (grid[row + axes[1][0][0]][col + axes[1][0][1]] == 'S' and grid[row + axes[1][1][0]][col + axes[1][1][1]] == 'M'):
                        total += 1
